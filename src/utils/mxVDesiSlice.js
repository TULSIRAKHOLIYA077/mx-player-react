...
const mxVDesiSlice = createSlice({
  name: "mxVDesi",
  initialState:{
...
export const {addmovieListOne, addmovieListTwo, addmovieListThree, addmovieListFour, addmovieListFive, addmovieListSix} = mxVDesiSlice.actions;

export default mxVDesiSlice.reducer;